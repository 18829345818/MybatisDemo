...
public class XMLConfigBuilder extends BaseBuilder {
	...
	private void info() {
		System.out.println(new GsonBuilder().excludeFieldsWithoutExposeAnnotation().create().toJson(configuration));
		System.out.println(configuration.typeAliasRegistry.TYPE_ALIASES);
	...
	private void typeAliasesElement(XNode parent) {
		...
		if (parent != null) {
			System.out.println("typeAliasesElement	" + parent.toString());
	...
	private void propertiesElement(XNode context) throws Exception {
		...
		if (context != null) {
			System.out.println("propertiesElement" + context.toString());
	...
	private void environmentsElement(XNode context) throws Exception {
		System.out.println("environmentsElement	" + context.toString());
		if (context != null) {
			if (environment == null) {
	...
	private void databaseIdProviderElement(XNode context) throws Exception {
		...
		if (context != null) {
			System.out.println("databaseIdProviderElement	" + context.toString());
			String type = context.getStringAttribute("type");
	...
	private void typeHandlerElement(XNode parent) throws Exception {
		...
		if (parent != null) {
			System.out.println("typeHandlerElement	" + parent.toString());
			for (XNode child : parent.getChildren()) {
				if ("package".equals(child.getName())) {
	...
	private void mapperElement(XNode parent) throws Exception {
		System.out.println("mapperElement	" + parent.toString());
		if (parent != null) {
			for (XNode child : parent.getChildren()) {
				if ("package".equals(child.getName())) {
